...
//TESTCODE:BEGIN
public class VersioningJavaSerializerTest extends AbstractTestBase {

    @Override
    protected final VersioningSerializer createVersioningSerializer(final ClassesHistory history) {
        return new VersioningJavaSerializer(history);
    }

    @Test
    public final void testDeserializeJavaV1() throws IOException, DeserializationException {
    ...
    @Test
    public final void testDeserializeJavaV2() throws IOException, DeserializationException {
    ...
    @Test
    public final void testDeserializeJavaV3() throws IOException, DeserializationException {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        final File file = new File(DATA_DIR, "AddressV3-java.bin");
        write(file, address, new VersioningJavaSerializer(readHistory()));
